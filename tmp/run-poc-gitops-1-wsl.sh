...
echo "🎯 Démarrage du POC GitOps Phase 1 - poc-gitops-1 (WSL)"
...
if ! grep -q "WSL" /proc/version 2>/dev/null; then
    log_warn "⚠️  Ce script est optimisé pour WSL. Continuer quand même..."
fi
...
echo "Supprimer le POC: ./scripts/cleanup-wsl.sh"